...
Usage
-----
python analyze_tactile_consonant_learning_v4_no_empty_rt_warning.py --data-dir data/logs --out-dir analysis_results

If your CSV files are somewhere else:
python analyze_tactile_consonant_learning_v4_no_empty_rt_warning.py --data-dir C:\path\to\logs --out-dir C:\path\to\analysis_results
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Analyze tactile consonant learning experiment logs. v5: item-level learned count bar plots.")
