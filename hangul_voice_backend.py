...
BASE_DIR = APP_DIR / "voice_profiles"
...
DEFAULT_ISI_MS = 150
SYLLABLE_ISI_MS = 250
SYLLABLE_FILE = APP_DIR / "syllable_top200.xlsx"
...
def load_hangul_jamo_model(subject_id):
    ...
    possible_paths = [
        BASE_DIR / subject_id / "jamo_voice_model.joblib",
        BASE_DIR / subject_id / "hangul_jamo_model.joblib",
        BASE_DIR / subject_id / "learned_voice_model.joblib",
    ]
...
def existing_voice_model_path(subject_id):
    return BASE_DIR / str(subject_id).strip() / "learned_voice_model.joblib"
